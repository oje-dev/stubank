...
var data = [
  { sentTo: " House ", date: " 2019-01-01T00:00:00.000Z ", amount: 400 },
...
//** Calls the websocket server, tries to predict the spending of the above array of transactions*/
test("predicts a variety transactions", (done) => {
  ...
  client.req(stringifiedTransactions, "ws://0.0.0.0:5003/", (data) => {
    callback(data);
  });
});
